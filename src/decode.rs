...
{
    #[inline]
    pub fn new(rdr: Iter) -> Result<Decoder<Iter>, Error> {
    ...
    where Iter: Iterator<Item=io::Result<u8>>,
{
        ...
        where T: de::Deserialize,
    {
        ...
        if self.first {
            ...
            if self.de.ch_is(b',') {
                ...
                return Err(self.de.error(ErrorCode::EOFWhileParsingArray));
            } else {
    ...
    fn end(&mut self) -> Result<(), Error> {
        ...
        if self.de.ch_is(b']') {
            ...
            Err(self.de.error(ErrorCode::EOFWhileParsingArray))
        } else {
    ...
    where Iter: Iterator<Item=io::Result<u8>>
{
        ...
        where K: de::Deserialize,
    {
        ...
        if self.de.ch_is(b'"') {
            return Err(self.de.error(ErrorCode::KeyMustBeAValue));
        }
...
impl<Iter> de::VariantVisitor for Decoder<Iter>
    where Iter: Iterator<Item=io::Result<u8>>,
{
    type Error = Error;
...
pub fn from_iter<I, T>(iter: I) -> Result<T, Error>
    where I: Iterator<Item=io::Result<u8>>,
          T: de::Deserialize,
{
    let mut de = try!(Decoder::new(iter));
